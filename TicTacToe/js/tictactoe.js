...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            //Active player may only be 'X' or 'O' so, if mot 'X' it must ne 'O'
        } else {
            //If activePlayer is equal tp 'O', the o.png is placed on HTML
        ...
        if (activePlayer === 'X') {
            ...
            //Changes the activvePlayer to 'X'
            activePlayer = 'X';
        }
        //This function plays placement sound.
        audio('./media/pop.mp3');
        //This condition checks to see if its is the compters turn.
        if (activePlayer === 'O') {
    ...
    function computersTurn() {
        ...
        let success = false;
        //This variable stores a randdom nuber 0-8.
        let pickASquare;
        //This condition allows our while looop to keep trying if a sqaure is selected already.
        while (!success) {
            //A random number between 0 and 8 is selected.
            pickASquare = String(Math.floor(Math.random() * 9));
            //If the random number evaluated returns true, the dquare hasn't been selected yet.
...
function checkWinConditions () {
    ...
    //9 sqaures ar selected the code exectes.
    else if (selectedSquares.length >= 9) {
        //This function plays the time game sound.
        audio('./media/whistle.mp3');
        //This function sets a .3 second timer before the resetGame is called.
        setTimeout(function () { resetGame(); }, 500);
    }
    //This function if an array includes 3 strings. It is used to check for
//each win condition.
    function arrayIncludes(sqaureA, sqaureB, sqaureC) {
        ...
        //If the 3 variable we pass are all inculded in our array then
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line gices us access to methods and properties to use on canvas.
    ...
    function animateLineDrawing() {
        ...
        c.beginPath();
        //This method moves us to a string point in out line.
        c.moveTo(x1, y1);
        //This method indicates the end point in out line.
        c.lineTo(x, y);
        //Tho method set the width of our line.
        c.lineWidth = 10;
    ...
    //This function clear our canvas afer our win line is drawn.
    function clear() {
    ...
    animateLineDrawing();
    //This line waits 1 second. Thwn, clears canvas resets games, an allows clicking again.
